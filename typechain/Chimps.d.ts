...
interface ChimpsInterface extends ethers.utils.Interface {
  functions: {
    "adminMintChimp(uint256,address)": FunctionFragment;
    "approve(address,uint256)": FunctionFragment;
    "balanceOf(address)": FunctionFragment;
    "baseURIValue()": FunctionFragment;
    ...
    "updateBaseURIValue(string)": FunctionFragment;
    "updateMintPrice(uint256)": FunctionFragment;
    "updateSaleStartTimestamp(uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "updateBaseURIValue",
    values: [string]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "updateSaleStartTimestamp",
    values: [BigNumberish]
  ): string;
  ...
  events: {
    ...
    "UpdateMintPrice(uint256)": EventFragment;
  };
...
export type ChimpsMintedEvent = TypedEvent<
  [BigNumber[], string] & { tokenIds: BigNumber[]; buyer: string }
>;
...
export type UpdateMintPriceEvent = TypedEvent<
  [BigNumber] & { newMintPrice: BigNumber }
>;

export class Chimps extends BaseContract {
  ...
  functions: {
    ...
    baseURIValue(overrides?: CallOverrides): Promise<[string]>;
    ...
    updateSaleStartTimestamp(
      _saleStartTimestamp: BigNumberish,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
  ...
  callStatic: {
    ...
    mintChimp(number: BigNumberish, overrides?: CallOverrides): Promise<void>;
  ...
  filters: {
    ...
    "UpdateMintPrice(uint256)"(
      newMintPrice?: null
    ): TypedEventFilter<[BigNumber], { newMintPrice: BigNumber }>;
  ...
  estimateGas: {
    ...
    baseURIValue(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    baseURIValue(overrides?: CallOverrides): Promise<PopulatedTransaction>;
